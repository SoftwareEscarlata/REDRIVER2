...
| 04 | [Rasterizer correctness](04-rasterizer-correctness.md) | Eight correctness defects: the symptom on a 320x240 panel, how each was cornered without a debugger, and the actual repair. Includes the offline audit programs and the pixel-identical `HAVANA.LEV` comparison. |
